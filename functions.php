...
//* Remove comment url from Jetpack https://wordpress.org/support/topic/remove-or-hide-website-field-from-jetpack-comment-system/
...
//* Remove Parent Function for Site Title
...
add_action( 'genesis_site_title', 'genesis_seo_site_title_new_link' );
/**
 * Added 12/2/2016 Different URL link on site title from Parent Function
 *
 */
function genesis_seo_site_title_new_link() {
